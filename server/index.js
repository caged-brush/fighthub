...
import fightsRoutes from "./routes/fights.ts";
import path from "path";
import fs from "fs";
import passport from "passport";
import multer from "multer";
import authProfileRoutes from "./routes/authProfile.ts";
import { createServer } from "http";
import { Server } from "socket.io";
import { fileURLToPath } from "url";
import fightersRoute from "./routes/fighter.ts";
...
import scoutsRoutes from "./routes/scout.ts";
